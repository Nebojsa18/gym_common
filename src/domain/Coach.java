 ...
 * @author Admin
 */
    public class Coach extends AbstractDO implements Serializable{
        private Long id;
    ...
    public Coach(Long id, String firstname, String lastname, Date birthday, Gender gender,
    ...
    public boolean equalsUserPass(Object obj) {
        if (this == obj) {
            return true;
        }
        if (obj == null) {
    ...
    public String getAttributeList() {
        return "coachid,firstname,lastname,birthday,gender,phone,username,password";
    }
    ...
    public AbstractDO getEntityFromResultSet(ResultSet rs) throws SQLException {
        return new Coach(rs.getLong("coachid"), rs.getString("firstname"), rs.getString("lastname"), rs.getDate("birthday"), Gender.valueOf(rs.getString("gender")), rs.getString("phone"), rs.getString("username"), rs.getString("password"));
    }

    @Override
    public String getStatementSelectAllQuery() {
         return "SELECT coachid,firstname,lastname,birthday,gender,phone,username,password FROM coach";
    }
